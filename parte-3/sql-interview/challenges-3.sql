...
En caso de no haber cambios, no mostrarlo. Un empleado renuncia cuando esta el primer año y no el segundo, y
viceversa para cuando un empleado se incorpora.
*/
...
cuantas fueron hechas por clientes que ya habian comprado ("repeat_customer"). 
...
/*
Armar una tabla que sirva como una version simplificada de un sistema de recomendacion y muestre, 
